...
$getDataCekList = mysqli_query($con ,"SELECT * FROM `form_filling_inspeksi_area` ");
$getDataProduksi = mysqli_query($con ,"SELECT * FROM `form_filling_produksi`");
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class=" items-center justify-evenly m-2 gap-4 w-full">
                <table>
                    <tr class="bg-black text-white p-2">
                        <th class="p-2">no_filling</th>
                        <th class="p-2">inspeksi_mesin/peralatan</th>
                        <th class="p-2">part_mesin/peralatan </th>
                    ...
                    while ($data = mysqli_fetch_array($getDataCekList)) {
                        ...
                        <tr class="text-xs bg-white border  ">
                            ...
                            <td class=" p-2 border border-black ">
                                <?php echo $data['part_mesin/peralatan']; ?>
                            </td>
            ...
            <div class=" items-center justify-evenly m-2 gap-4 w-full">
                <table>
                    <tr class="bg-black text-white p-2">
                        ...
                        <th class="p-2">no_plan</th>
                        <th class="p-2">hasil</th>
                        <th class="p-2">no_hasil</th>
